import 'dart:convert';
import 'package:medium_weather_app/app_body.dart';
import 'package:medium_weather_app/app_bottom_bar.dart';
import 'package:medium_weather_app/app_top_bar.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:medium_weather_app/location_service.dart';
...
class _WeatherAppState extends State<WeatherApp> with TickerProviderStateMixin {
  ...
  final Color _backgroundColor = const Color.fromARGB(255, 13, 13, 14);
  ...
  void _initializeLocation() async {
    ...
    try {
      ...
      changeLatAndLong(lat, long); // já atualiza e busca o clima
      setState(() {
